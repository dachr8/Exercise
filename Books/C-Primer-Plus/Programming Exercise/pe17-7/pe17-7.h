//pe17-7.h: copy of tree.h -- binary search tree
...
//postconditions: if possible, function adds item to tree and returns true;
...
//                ptree points to an initialized tree
//postconditions: if possible, function deletes item from tree and returns true;
//                otherwise, the function returns false
...
//preconditions:  pi points to an item
//                ptree points to an initialized tree
//postconditions: function returns address if item is in tree and returns NULL otherwise
